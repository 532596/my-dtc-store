...
export default function HeroShowcase({ slides }: { slides: HeroSlide[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-[85vh] w-full max-w-content flex-col px-4 pb-14 pt-14 md:min-h-[92vh] md:px-8 md:pt-16">
        {/* 仅标题与说明左移；与底部切换条同宽基准，不牵动下方卡片 */}
        <div className="max-w-4xl -translate-x-1 text-white drop-shadow-[0_14px_40px_rgba(0,0,0,0.6)] md:-translate-x-2">

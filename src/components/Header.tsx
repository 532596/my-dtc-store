            ...
            {activePanel === "/support" && (
              <>
                <aside className="w-52 shrink-0 rounded-xl bg-[#151821] py-4 pr-4" onMouseLeave={() => setMegaSupportSub(0)}>
                  ...
                  <Link href="/support/returns" onMouseEnter={() => setMegaSupportSub(3)} className={`block rounded-lg px-4 py-2.5 text-sm font-medium text-foreground transition-all duration-200 hover:bg-warm-cream/70 hover:translate-x-0.5 ${megaSupportSub === 3 ? "bg-warm-cream/60" : ""}`}>退换货</Link>

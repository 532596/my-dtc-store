            ...
            {activePanel === "/support" && (
              <>
                <aside className="w-52 shrink-0 rounded-xl bg-warm-gray/20 py-4 pr-4" onMouseLeave={() => setMegaSupportSub(0)}>
                  ...
                  <Link href="/support/returns" onMouseEnter={() => setMegaSupportSub(5)} className={`block rounded-lg px-4 py-2.5 text-sm font-medium text-foreground transition-all duration-200 hover:bg-warm-cream/70 hover:translate-x-0.5 ${megaSupportSub === 5 ? "bg-warm-cream/60" : ""}`}>退换货</Link>
                ...
                <div className="ml-10 flex-1">
                  ...
                  {megaSupportSub === 3 && (
                    <>
                      ...
                      <div className="mt-6 flex flex-wrap gap-3">
                        <Link href="/support/returns" className="rounded-lg border border-warm-gray/40 bg-warm-cream/20 px-4 py-2.5 text-sm font-medium text-foreground transition hover:border-accent hover:bg-warm-cream/40">配送与退换 →</Link>
                      </div>
                    </>
                  )}
                  {megaSupportSub === 4 && (
                  ...
                  {megaSupportSub === 5 && (
                    <>
                      ...
                      <div className="mt-6 flex flex-wrap gap-3">
                        <Link href="/support/returns" className="rounded-lg border border-warm-gray/40 bg-warm-cream/20 px-4 py-2.5 text-sm font-medium text-foreground transition hover:border-accent hover:bg-warm-cream/40">查看退换政策 →</Link>
                      </div>
                    </>
                  )}
                </div>

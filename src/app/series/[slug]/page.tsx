...
> = {
  "model-a": {
    ...
    colours: ["银色", "白色", "黑色"],
    images: ["/images/model-a.jpg", "/images/model-a.jpg", "/images/model-a.jpg"],
  ...
  "model-b": {
    ...
    colours: ["银色", "黑色"],
    images: ["/images/model-b.jpg", "/images/model-b.jpg", "/images/model-b.jpg"],
  ...
  "model-c": {
    ...
    colours: ["银色", "黑色", "胡桃木色"],
    images: ["/images/model-c.jpg", "/images/model-c.jpg", "/images/model-c.jpg"],
...
export default function ProductPage(props: { params: { slug: string } }) {
  ...
  return (
    <main className="min-h-screen bg-[#1c1c1e]">
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,50%)_1fr]">
        {/* 左侧：主图区（深色），比例约 50% */}
